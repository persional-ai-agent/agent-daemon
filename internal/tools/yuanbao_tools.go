...
func ybSearchStickerParams() map[string]any {
	return map[string]any{"type": "object", "properties": map[string]any{"query": map[string]any{"type": "string"}, "limit": map[string]any{"type": "integer", "minimum": 1, "description": "Maximum stickers to return (default 10)."}}}
}
...
func ybQueryGroupMembersParams() map[string]any {
	return map[string]any{"type": "object", "properties": map[string]any{"group_code": map[string]any{"type": "string"}, "chat_id": map[string]any{"type": "string"}, "offset": map[string]any{"type": "integer", "minimum": 0, "description": "Pagination offset (default 0)."}, "limit": map[string]any{"type": "integer", "minimum": 1, "description": "Page size (default 200)."}}, "required": []string{}}
}
