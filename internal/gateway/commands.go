...
var gatewayCommandCatalog = []gatewayCommandSpec{
	...
	{Name: "whoami", Description: "show gateway identity and mapped global id"},
	{Name: "resolve", Description: "resolve route/mapped session for a gateway user", HelpUsage: "/resolve [platform chat_type chat_id user_id [user_name]]"},
	{Name: "setid", Description: "bind current platform user to a global identity", HelpUsage: "/setid <global_user_id>"},
	{Name: "unsetid", Description: "remove global identity binding for current user"},
	...
	{Name: "policy", Description: "show or update gateway interaction policy", HelpUsage: "/policy [show|mention on|mention off|groupdm both|groupdm group_only|groupdm dm_only]"},
