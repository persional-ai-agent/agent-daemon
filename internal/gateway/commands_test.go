...
func TestBuiltInGatewaySlashCommandsContainsCoreSet(t *testing.T) {
	...
	want := map[string]bool{
		"/pair": true, "/unpair": true, "/session": true, "/history": true, "/show": true, "/next": true, "/prev": true, "/sessions": true, "/pick": true, "/stats": true, "/new": true, "/reset": true, "/resume": true, "/recover": true, "/retry": true, "/undo": true, "/clear": true, "/reload": true, "/save": true, "/sethome": true, "/model": true, "/skills": true, "/tools": true, "/cancel": true, "/compress": true, "/usage": true, "/queue": true,
...
func TestGatewayCommandRequiresAuthorization(t *testing.T) {
	...
	want := map[string]bool{
		"/session": true, "/history": true, "/show": true, "/next": true, "/prev": true, "/sessions": true, "/pick": true, "/stats": true, "/new": true, "/reset": true, "/resume": true, "/recover": true, "/retry": true, "/undo": true, "/clear": true, "/reload": true, "/save": true, "/sethome": true, "/model": true, "/skills": true, "/tools": true, "/cancel": true, "/compress": true, "/usage": true, "/queue": true, "/status": true, "/approve": true, "/deny": true,
