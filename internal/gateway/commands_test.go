...
func TestBuiltInGatewaySlashCommandsContainsCoreSet(t *testing.T) {
	...
	want := map[string]bool{
		"/pair": true, "/unpair": true, "/session": true, "/history": true, "/new": true, "/reset": true, "/resume": true, "/recover": true, "/retry": true, "/undo": true, "/cancel": true, "/compress": true, "/queue": true,
...
func TestGatewayCommandRequiresAuthorization(t *testing.T) {
	...
	want := map[string]bool{
		"/session": true, "/history": true, "/new": true, "/reset": true, "/resume": true, "/recover": true, "/retry": true, "/undo": true, "/cancel": true, "/compress": true, "/queue": true, "/status": true, "/approve": true, "/deny": true,
