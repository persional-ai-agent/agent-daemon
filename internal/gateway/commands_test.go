...
func TestBuiltInGatewaySlashCommandsContainsCoreSet(t *testing.T) {
	...
	want := map[string]bool{
		"/pair": true, "/unpair": true, "/new": true, "/reset": true, "/recover": true, "/retry": true, "/undo": true, "/cancel": true, "/compress": true, "/queue": true,
...
func TestGatewayCommandRequiresAuthorization(t *testing.T) {
	...
	want := map[string]bool{
		"/new": true, "/reset": true, "/recover": true, "/retry": true, "/undo": true, "/cancel": true, "/compress": true, "/queue": true, "/status": true, "/approve": true, "/deny": true,
