...
| CLI/TUI | 部分对齐 | 已有交互式 chat、serve、tools list/show/schemas/enable/disable、config、model、doctor、`setup`、gateway 与最小 `gateway setup`；未实现 Hermes 全屏 TUI、交互式 setup wizard、update 等完整命令体系 |
...
- 全屏 TUI、交互式 setup wizard、update 和更完整的 CLI 管理面
