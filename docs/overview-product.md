...
| CLI/TUI | 部分对齐 | 已有交互式 chat、serve、tools list/show/schemas/enable/disable、config、model、doctor、`setup`/`setup wizard`、最小 `update`、gateway 与最小 `gateway setup`；未实现 Hermes 全屏 TUI、安装器级 update 与更完整命令体系 |
