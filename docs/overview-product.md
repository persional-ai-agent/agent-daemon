...
| CLI/TUI | 部分对齐 | 已有交互式 chat、serve、tools list/show/schemas/enable/disable、config、model、doctor、`setup`/`setup wizard`、gateway 与最小 `gateway setup`；未实现 Hermes 全屏 TUI、完整 setup/update 命令体系 |
...
- 全屏 TUI、完整 update 流程和更完整的 CLI 管理面
