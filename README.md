...
- 内置工具注册与分发
- 内置工具：`terminal`、`process`（兼容 `process_status`/`stop_process`）、`read_file`、`write_file`、`patch`、`search_files`、`todo`、`memory`、`session_search`、`web_fetch`、`web_search`、`web_extract`、`clarify`、`delegate_task`
